...
class IQ2020Component : public PollingComponent, public uart::UARTDevice {
  ...
  SUB_SENSOR(baseline_voltage)
  SUB_SENSOR(heater_voltage)
  SUB_SENSOR(aux_voltage)
  SUB_SENSOR(jets_blower_voltage)
  SUB_SENSOR(baseline_current)
  SUB_SENSOR(heater_current)
  SUB_SENSOR(aux_current)
  SUB_SENSOR(jets_blower_current)
  SUB_SENSOR(baseline_power)
  SUB_SENSOR(aux_power)
  SUB_SENSOR(jets_blower_power)
  SUB_SENSOR(heater_power)
  SUB_SENSOR(filter1_time)
  SUB_SENSOR(filter2_time)
  SUB_SENSOR(pcb_temp)
  SUB_SENSOR(panel_type)
